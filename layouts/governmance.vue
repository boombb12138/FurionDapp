...
::v-deep {
  ...
  .el-menu-item.is-active {
    ...
    &::after {
      ...
      left: 0;
      height: 100%;
      background: linear-gradient(0deg, #f181de, #f181de);
    }
  }
...
<template>
  <div>
    <div class="min-h-100vh bg-[#01132e] text-[#FCFFFD] relative">
      ...
      <div class="header">
        <div class="box w-1200px mx-auto">
      ...
      <div class="w-240px fixed center-x top-150px bottom-40px aside -ml-550px">
        <div class="text-center mb-110px">
          ...
          <img src="@/assets/images/join.svg" class="cursor-pointer hover:opacity-80" />
        </div>

        <el-menu
          class="!border-0 flex-1 !mr-0"
          :default-active="activeMenu"
          background-color="transparent"
          text-color="#86898C"
          router
        >
          <el-menu-item index="/governmance">
            <span>Proposal</span>
          </el-menu-item>

          <el-menu-item index="/governmance/new_proposal">
            <span>New proposal</span>
          </el-menu-item>

          <el-menu-item index="/governmance/entrust">
            <span>Entrust</span>
          </el-menu-item>

          <el-menu-item index="/governmance/about">
            <span>About</span>
          </el-menu-item>
        </el-menu>
      </div>
      ...
      <div class="pt-80px">
        <nuxt class="min-h-100vh relative w-1000px mx-auto left-100px" />
      </div>
    </div>
