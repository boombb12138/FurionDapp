        ...
        <div class="card1 px-32px">
          ...
          <div class="box h-198px pt-30px">
            ...
            <div class="text-[#8B93A2] font-500 text-15px leading-18px mt-16px">
              ...
              all. (⚠Please also note that unstaking FUR will make veFUR balance zero
              instantly.)
            </div>
          </div>
        </div>
        ...
        <div class="card2 px-22px pt-28px">
          ...
          <div class="box pt-26px h-230px mb-20px !px-17px">
            ...
            <div class="flex items-center justify-between">
              <div class="btn1" @click="stake = 1; reset(); handleAmt()" :class="{ grey: stake != 1 }">{{this.checkValue(1)}}</div>
              <div class="btn1" @click="stake = 2; reset(); handleAmt()" :class="{ grey: stake != 2 }">
                {{this.checkValue(2)}}
              </div>
            </div>
          </div>
          ...
          <div class="box pt-26px h-230px !px-17px">
            ...
            <div class="flex mb-20px">
              <div class="flex-1">
                ...
                <div class="font-700 text-24px">{{formatNumber(user.total_user_fur_stake)}} FUR</div>
            ...
            <div class="btn1-2" v-if="connected" @click="claimReward">
              Claim veFUR
            </div> 
    ...
    export default {
      ...
      methods: {
        ...
        async checkFURApproval() {
          ...
          try {
            await fur_contract.methods.allowance(account, this.user.veFur_address).call().then(allowance => {
              if (allowance > 0) {
                this.approved = true;
            ...
            console.log('[Check FUR Approval] Error here!');
            console.warn(e);
            return;
          }
        },
        ...
        async approveFURToken() {
          ...
          try {
            ...
            console.log('[Approve FUR Token] Error here!');
            console.warn(e);
            return;
          }
        },
