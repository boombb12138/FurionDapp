        ...
        <div class="box pt-26px h-230px !px-17px">
          ...
          <div class="flex mb-20px">
            <div class="flex-1">
              ...
              <div class="font-500 text-16px text-[#8B93A2] mt-5px">0 FUR per day</div>
            </div>
            <div class="flex-1">
              <div class="font-500 text-16px text-[#8B93A2] mb-5px">FUR Balance</div>
              <div class="font-700 text-24px">0 FUR</div>
              <div class="font-500 text-16px text-[#8B93A2] mt-5px">0 pending FUR</div>
            </div>
          </div>

          <div class="btn1-2" :class="{ grey: !claim }" @click="claim = true">
            Claim Pending FUR
          </div>
        </div>
      </div>
