        ...
        <div class="w-1168px mx-auto grid grid-cols-2 gap-x-25px">
          ...
          <div class="card">
            ...
            <div class="info">
              ...
              <div class="value">{{formatNumber(user.total_veFur_stake)}} veFUR</div>
            </div>
            <div class="info">
              <div class="key">Total veFUR Supply</div>
              <div class="value">{{formatNumber(user.total_veFur_supply)}} veFUR</div>
            ...
            <div class="info">
              <div class="key">Your Stake (veFUR)</div>
              <div class="value">{{formatNumber(user.current_veFur_stake)}} FUR</div>
            </div>
            <div class="info">
            ...
            <div class="info">
              ...
              <div class="value">{{formatNumber(user.pending_fur_reward)}} FUR</div>
            </div>
    ...
    export default {
      ...
      methods: {
        async updateUserInfo() {
          ...
          //console.log('[Staking] account: ', account);
