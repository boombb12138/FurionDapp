  ...
  <div class="z-1001" :class="{ 'el-dialog__wrapper': show }" v-if="showInfo.showPet">
    <div class="pet center-y mt-100px z-100" @click="show = true">
      ...
      <div class="el-popover el-popper el-popover--plain" x-placement="top-end" v-if="textIndex==4">
        ...
        <div class="underline inline-block" x-placement="top-end" @click="clickopen('https://medium.com/@project.furion/furion-pedia-concentrated-liquidity-in-aggregate-pool-14cea811804e')">
      ...
      <div class="el-popover el-popper el-popover--plain" x-placement="top-end" v-if="textIndex==5">
        ...
        <div class="underline inline-block" x-placement="top-end" @click="clickopen('https://docs.furion.io/token/fur')">
          here
        </div>
        <div class="inline-block" x-placement="top-end">
          !
      ...
      <div class="el-popover el-popper el-popover--plain" x-placement="top-end" v-if="textIndex==6">
        ...
        <div class="underline inline-block" x-placement="top-end" @click="clickopen('https://docs.furion.io/token/vefur')">
          this
        </div>
        <div class="inline-block" x-placement="top-end">
          !
      ...
      <div class="el-popover el-popper el-popover--plain" x-placement="top-end" v-if="textIndex==7">
        ...
        <div class="underline inline-block" x-placement="top-end" @click="clickopen('https://docs.furion.io/governance/fees-and-income-sharing')">
          Here
        </div>
        <div class="inline-block" x-placement="top-end">
