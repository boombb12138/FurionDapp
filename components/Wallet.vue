...
.top1 {
  background: url('@/assets/images/icon_top_01.png');
...
.top2 {
  ...
  &:hover {
    background: url('@/assets/images/icon_top_02_hover.png');
  }
}
</style>
...
<template>
  <div>
    ...
    <!-- <el-button
      ...
      @click="$store.commit('update', ['admin.connectDialog', 'simple'])"
    >
      Connect Wallet
    </el-button> -->
    <!-- <el-button
